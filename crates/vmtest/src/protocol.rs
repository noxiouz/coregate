//! JSON-line protocol between the host harness and the guest `vmtest-agent`.
//!
//! Keep this protocol small and serializable with plain `serde_json`; it runs
//! over a virtio-serial port during VM tests.
